  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        gold: "0 4px 24px oklch(0.72 0.1 65 / 0.2)",
        "gold-lg": "0 8px 40px oklch(0.72 0.1 65 / 0.25)",
        elegant: "0 2px 20px oklch(0.22 0.018 45 / 0.08)",
        "elegant-lg": "0 8px 40px oklch(0.22 0.018 45 / 0.12)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
